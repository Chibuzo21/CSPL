      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-14'>
        <div className='text-center'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center mb-16'>
            <Link
              href='/blog'
              className='group inline-flex items-center justify-center px-8 py-4 bg-secondary-600 hover:bg-secondary-700 text-white rounded-xl font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl'>
              <svg
